...
function AlertDialogOverlay({
	...
	return (
		<AlertDialogPrimitive.Overlay
			...
			className={cn(
				"fixed inset-0 z-[120] bg-black/10 duration-100 supports-backdrop-filter:backdrop-blur-xs data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0",
				className
			)}
			{...props}
		/>

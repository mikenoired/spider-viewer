...
const tableDefinitions = [
	...
	[
		...
		`create table if not exists remarks (
			...
			stage priority_list_kanban_status,
	...
	[
		"remark_cable_items",
		`create table if not exists remark_cable_items (
			id uuid primary key default gen_random_uuid(),
...
const columnDefinitions = [
	...
	["priority_room_lists", "title text not null default ''"],
	["priority_room_lists", "priority text not null default 'normal'"],
	["priority_room_lists", "task_code text"],
	["priority_room_lists", "parent_list_id uuid"],
	["priority_room_lists", "deadline date"],
	...
	["cable_list_items", "is_completed boolean not null default false"],
	["cable_list_items", "completed_at timestamp with time zone"],
	["cable_list_items", "completed_by_user_id uuid"],
	["task_events", "payload jsonb not null default '{}'::jsonb"],
	["task_events", "reverted_at timestamp with time zone"],
	["task_events", "reverted_by_user_id uuid"],
	...
	["remarks", "stage priority_list_kanban_status"],
...
const indexStatements = [
	...
	"create index if not exists remark_cable_items_cable_idx on remark_cable_items (cable_id)",
	"create unique index if not exists remark_cable_items_remark_cable_unique on remark_cable_items (remark_id, cable_id)",
...
const foreignKeyDefinitions = [
	...
	[
		"priority_room_lists_parent_list_id_fk",
		"priority_room_lists",
		"parent_list_id",
		"priority_room_lists",
		"id",
	...
	[
		"cable_list_items_completed_by_user_id_fk",
		"cable_list_items",
	...
	["task_events_reverted_by_user_id_fk", "task_events", "reverted_by_user_id", "users", "id", "set null"],
	["remark_cable_items_remark_id_fk", "remark_cable_items", "remark_id", "remarks", "id", "cascade"],
	["remark_cable_items_cable_id_fk", "remark_cable_items", "cable_id", "cables", "id", "restrict"],

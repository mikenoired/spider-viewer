...
CREATE INDEX "import_snapshots_active_idx" ON "import_snapshots" USING btree ("is_active");--> statement-breakpoint
CREATE UNIQUE INDEX "import_snapshots_single_active_unique" ON "import_snapshots" USING btree ("is_active") WHERE "import_snapshots"."is_active" = true;--> statement-breakpoint
